...
rotateButton.addEventListener("click", ()=>{
    ...
    `;
        ...
        setTimeout(()=>{
            if (spinCount < 2) rotateButton.disabled = false;
            else rotateButton.disabled = true;
        }, 3000);
    }
});
...
togglePasswordIcon.addEventListener('click', function() {
    ...
    if (passwordToggleText) passwordToggleText.textContent = isPasswordVisible ? 'Visible' : 'Hidden';
});
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function toggleSubmitButton() {
        ...
        if (emailValue && isEmailValid || phoneValue && isPhoneValid) submitButton.disabled = false;
...
},{"./main.scss":"kuRHr"}],"kuRHr":[function() {},{}]},["dYUC4","8ZNvh"], "8ZNvh", "parcelRequire94c2")
